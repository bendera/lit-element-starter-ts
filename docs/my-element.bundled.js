 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,s,i,e){const n=s[0];if("."===n){return new k(t,s.slice(1),i).parts}return"@"===n?[new j(t,s.slice(1),e.eventContext)]:"?"===n?[new C(t,s.slice(1),i)]:new S(t,s,i).parts}handleTextExpression(t){return new $(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
var tt=function(t,s,i,e){for(var n,o=arguments.length,r=o<3?s:null===e?e=Object.getOwnPropertyDescriptor(s,i):e,h=t.length-1;h>=0;h--)(n=t[h])&&(r=(o<3?n(r):o>3?n(s,i,r):n(s,i))||r);return o>3&&r&&Object.defineProperty(s,i,r),r};let st=class extends Z{constructor(){super(...arguments),this.name="World",this.count=0}render(){return N`
      <h1>Hello, ${this.name}!</h1>
      <button @click=${this._onClick} part="button">
        Click Count: ${this.count}
      </button>
      <slot></slot>
    `}_onClick(){this.count++}foo(){return"foo"}};st.styles=((t,...s)=>{const i=s.reduce((s,i,e)=>s+(t=>{if(t instanceof X)return t.cssText;if("number"==typeof t)return t;throw new Error(`Value passed to 'css' function must be a 'css' function result: ${t}. Use 'unsafeCSS' to pass non-literal values, but\n            take care to ensure page security.`)})(i)+t[e+1],t[0]);return new X(i,Q)})`
    :host {
      display: block;
  ...
  `,tt([G()],st.prototype,"name",void 0),tt([G({type:Number})],st.prototype,"count",void 0),st=tt([B("my-element")],st);var it=function(t,s,i,e){for(var n,o=arguments.length,r=o<3?s:null===e?e=Object.getOwnPropertyDescriptor(s,i):e,h=t.length-1;h>=0;h--)(n=t[h])&&(r=(o<3?n(r):o>3?n(s,i,r):n(s,i))||r);return o>3&&r&&Object.defineProperty(s,i,r),r};let et=class extends Z{constructor(){super(...arguments),this.label="My button"}render(){return N`
      <button>${this.label}</button>
    `}};it([G()],et.prototype,"label",void 0),et=it([B("my-button")],et);export{et as MyButton,st as MyElement};
